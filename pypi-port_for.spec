...
Source0  : https://files.pythonhosted.org/packages/a5/d5/5ccbaad9c76fc1ea18644b2ec9493788a7be0bf0c3d1a0ac760fde6c388f/port_for-0.7.3.tar.gz
...
%prep
%setup -q -n port_for-0.7.3
cd %{_builddir}/port_for-0.7.3
pushd ..
cp -a port_for-0.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725306558
